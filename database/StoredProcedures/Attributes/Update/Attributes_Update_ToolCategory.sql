DROP PROCEDURE IF EXISTS Attributes_Update_ToolCategory;

DELIMITER ;;
CREATE PROCEDURE Attributes_Update_ToolCategory(
...
# CALL Attributes_Update_ToolCategory(1, 1, 'test-changed', 'test-changed-desc', 'ab');
