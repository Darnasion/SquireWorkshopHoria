DROP PROCEDURE IF EXISTS Attributes_Update_WeaponType;

DELIMITER ;;
CREATE PROCEDURE Attributes_Update_WeaponType(
...
# CALL Attributes_Update_WeaponType(1, 1, 'test-changed', 'test-changed-desc', 'ab');
