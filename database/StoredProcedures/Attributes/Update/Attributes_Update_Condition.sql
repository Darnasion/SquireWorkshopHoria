DROP PROCEDURE IF EXISTS Attributes_Update_Condition;

DELIMITER ;;
CREATE PROCEDURE Attributes_Update_Condition(
...
# CALL Attributes_Update_Condition(1, 1, 'test-changed', 'test-changed-desc', 'ab');
