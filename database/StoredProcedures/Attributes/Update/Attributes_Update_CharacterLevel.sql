DROP PROCEDURE IF EXISTS Attributes_Update_CharacterLevel;

DELIMITER ;;
CREATE PROCEDURE Attributes_Update_CharacterLevel(
...
# CALL Attributes_Update_CharacterLevel(1, 1, 'test-changed', 'test-changed-desc', 'ab');
