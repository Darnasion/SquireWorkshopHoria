DROP PROCEDURE IF EXISTS Attributes_Update_WeaponProperty;

DELIMITER ;;
CREATE PROCEDURE Attributes_Update_WeaponProperty(
...
# CALL Attributes_Update_WeaponProperty(1, 1, 'test-changed', 'test-changed-desc', 'ab');
