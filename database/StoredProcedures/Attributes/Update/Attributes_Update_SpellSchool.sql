DROP PROCEDURE IF EXISTS Attributes_Update_SpellSchool;

DELIMITER ;;
CREATE PROCEDURE Attributes_Update_SpellSchool(
...
# CALL Attributes_Update_SpellSchool(1, 1, 'test-changed', 'test-changed-desc', 'ab');
