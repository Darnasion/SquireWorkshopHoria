DROP PROCEDURE IF EXISTS Attributes_Update_DamageType;

DELIMITER ;;
CREATE PROCEDURE Attributes_Update_DamageType(
...
# CALL Attributes_Update_DamageType(1, 1, 'test-changed', 'test-changed-desc', 'ab');
